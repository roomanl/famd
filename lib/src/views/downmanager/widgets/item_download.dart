...
//     // M3u8Task task = controller.getTask(taskIndex);
//     return Obx(
//       () => Container(
...
buildItemDownload(M3u8Task task) {
  final homeCtrl = Get.find<DownManagerController>();
  return Container(
    padding: const EdgeInsets.all(10),
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
        ...
        Row(
          children: <Widget>[
            ...
            IconButton(
              ...
              onPressed: homeCtrl.deleteTask(task, false),
            ),
          ],
        ),
        Row(
